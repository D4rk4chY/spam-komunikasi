...
mulai (){
    echo "Gunakan SPAM KOMUNIKASI TOOLS Lagi?"
    echo "y/n?"
    echo
    read lagi
    if [ $lagi = "y" ]; then
            ...
            echo "Terima Kasih Atas Partisipasinya"
			echo "Gunakanlah Tools dengan bijak ya kawan!"
			echo "--D4rk4chy--"
    fi
}
#spam
spam(){
    ...
    echo "[1] Spam SMS"
    echo "[2] Spam Telp"
    echo "[3] Close SPAM KOMUNIKASI TOOLS"
    echo
    echo "1/2/3?"
    read pilih
    if [ $pilih = "1" ]; then
            ...
            echo
            echo "Jumlah sms yang mau dikirim:"
            read paket
            echo
        ...
        echo "Terimakasih sudah menggunakan SPAM KOMUNIKASI TOOLS"
        close
    else
        clear
        echo "Kesalahan"
...
clear
SPAM KOMUNIKASI TOOLS
echo Selamat datang di DUNIA -D4rk4chy-, Siapa nama anda? #tulisan keluar
read nick #membaca yang ditulis
clear
SPAM KOMUNIKASI TOOLS
echo Selamat datang $nick ":)"
echo
echo "Mulai SPAM KOMUNIKASI TOOLS?"
echo "y/n?"
read mulai
if [ $mulai = "y" ]; then
      spam
